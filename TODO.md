...
- [x] standalone emulator binaryをPixel2向けに順次build・実機検証する
  ...
  - [ ] 2026-08-28: standalone Mupen64Plus 2.6.0を追加選択肢として移植する。pinned 6 component、Rice GLES2、Pixel2最終回転、`pixel2_joypad`、FUNCTION終了、plumOS音声経路のhost buildは完了。既定`retroarch:parallel_n64`は維持し、正式app-layer、実機の起動・画面・入力・音声・終了・FE復帰を検証する。
